...
--  or
select avg("diff_time") as "avg_diff_time", "days"
from
(select ("tpep_dropoff_datetime" - "tpep_pickup_datetime") as diff_time, to_char("tpep_pickup_datetime", 'day') as "days"
from "yellow_tripdata_2015-01"
group by "tpep_dropoff_datetime", "tpep_pickup_datetime", "days") as tab
where "days"  like '%sat%'
group by "days";

-- 4.The average number of trip on sundays
select avg("trip_distance") as avg_trip_distance, "days"
from
(select "tpep_pickup_datetime", to_char ("tpep_pickup_datetime", 'day') as "days", "trip_distance"
from "yellow_tripdata_2015-01") as "table1"
